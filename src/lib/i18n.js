...
i18n
  ...
  .init({
    ...
    ns: ['commun', 'dashboard', 'ventes', 'stock', 'clients', 'commandes', 'tournees', 'analyseia', 'mesversements', 'mouvementsstock', 'carteclients', 'grandlivre', 'depots', 'localiserstock', 'groupes', 'rapports', 'versements', 'objectifs', 'stockcommercial', 'utilisateurs', 'analytique', 'creances', 'messagerie', 'parametres', 'apparence', 'journalcaisse', 'aide', 'banques'],
    defaultNS: 'commun',
