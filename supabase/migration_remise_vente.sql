-- Migration : remise ponctuelle sur une vente (distincte des tarifs négociés
-- permanents déjà en place via tarifs_client). Le prix catalogue de chaque
-- ligne reste intact — la remise s'applique en un seul montant visible sur
-- la facture, avec motif obligatoire, pour ne jamais fausser silencieusement
-- les statistiques qui s'appuient sur prix_unitaire.
