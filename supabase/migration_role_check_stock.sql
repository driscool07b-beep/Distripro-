-- Migration : creer_produit et ajuster_stock n'avaient aucune vérification
-- de rôle — n'importe quel utilisateur connecté (commercial, comptable...)
-- pouvait créer un produit ou ajuster le stock magasin en appelant la RPC
-- directement, même si les boutons étaient masqués dans l'interface.
-- Restreint désormais à admin/manager/gestionnaire_stock.
